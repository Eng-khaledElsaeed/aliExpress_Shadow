<template>
    <div class="flex justify-start my-2">
        ...
        <img class="rounded-md md:w-[150px] w-[90px]" :src="product.url" alt="product">
        <div class="ovelflow-hidden pl-2 w-full">
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center justify-between truncate">
                    <span class="sm:block hidden bg-[#fd374f] text-white text-[9px] p-0.5 font-semibold rounded-md">Welcome Deal</span>
            ...
            <div class="text-xl font-semibold">
                <!--{{ product.price.currencySign }}-->$<span class="font-bold">{{ product.price/100 }}</span>
            </div>
            <div class="text-[#009a66] text-xs font-semibold pt-1">
                Free 11-day delivery over $ 10
            </div>
            <div class="text-[#009a66] text-xs font-semibold pt-1">
                <!-- Free shipping -->
            </div>
