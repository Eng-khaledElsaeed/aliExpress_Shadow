    ...
    <MainLayout>
        <div id="ItemPage" class="mt-4 max-w-[1200px] mx-auto px-2">
            <div class="md:flex gap-4 justify-between mx-auto w-full">
                ...
                <div class="md:w-[60%] bg-white rounded-lg px-1 py-1">
                    ...
                    <div class="flex items-center justify-start my-2">
                        ...
                        <Icon name="material-symbols:star-rate" color="#FF5353"/>
                        <Icon name="material-symbols:star-rate" color="#FF5353"/>
                        <span class="text-[13px] font-light ml-2">5 213 Reviewes 1,000+ orders</span>
                    </div>
                    <div class="border-b" /> 
                    <div class="flex items-center justify-start gap-2 my-2">
                        <div class="text-xl font-bold">${{ priceCompute }}</div>
